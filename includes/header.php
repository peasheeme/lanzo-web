...
<head>
	...
	<!-- Author Meta -->
	<meta name="author" content="3e-digital">
	<!-- Meta Description -->
	<meta name="description" content="lorem	ipsum dolor">
	<!-- Meta Keyword -->
	<meta name="keywords" content="  ">
	<!-- meta character set -->
	<title>Lanzo | Protegemos tus Ideas </title>
	<!-- CSS -->
	<!-- Bootstrap core CSS -->
		...
		<div class="row">
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.php"><img src="assets/images/logo.png" width="150"></a>
				</div>
